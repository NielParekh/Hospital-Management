...
class Technician extends Person implements staff
{
	...
	Technician(String Title,String Name,String DoB,String gender,String Home_address,long ph_no,int experience,String[] Education,String JoiningDate,float Salary,int clearance)
	{
		super(Title, Name, DoB, gender, Home_address, ph_no);
		this.experience = experience;
		this.Education = Education;
...
class TechNotFoundException extends Exception
{
	private int det;
...
class Project
{
	...
	public int tech_search_details(Technician[] tech,int nd, String name) throws TechNotFoundException
	{
		int flag = 0;
		int pos =0;
		for(int i = 0 ;i <nd; i++)
					...
					case 2:
						...
						switch(q)
						{
							case 1:
							        ...
							        tech[tcount] = new Technician(title,name,DoB,gender,address,pn,exp,qual,jdate,sal,cle);							       
							        tcount+=1;
							       try
						       	         {
							...
							case 2:
								...
								try
								{
									int position = pro.tech_search_details(tech,ntech,name);
									per = tech[position];
